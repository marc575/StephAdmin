 ...
 */
final class Version20220829061516 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE coupon (id INT AUTO_INCREMENT NOT NULL, auteur VARCHAR(255) NOT NULL, bookmaker VARCHAR(255) NOT NULL, code VARCHAR(255) NOT NULL, message VARCHAR(255) NOT NULL, file_name VARCHAR(254) NOT NULL, createdAt DATETIME DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
