 ...
 */
class getEmailsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EmailsRepository' shared autowired service.
     *
     * @return \App\Repository\EmailsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EmailsRepository.php';

        return $container->privates['App\\Repository\\EmailsRepository'] = new \App\Repository\EmailsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
